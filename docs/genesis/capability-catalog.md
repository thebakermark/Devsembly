...
|---|---|---|---|
| Organization registry | Organization domain | Planned | PostgreSQL application module |
| Initiative and project registry | Portfolio domain | Planned | PostgreSQL application module |
| Budget policy and forecasting | Budget domain | Planned | `$50/month` reference constraint |
...
| Domain event delivery | Event capability | Planned | PostgreSQL transactional outbox |
...
| Independent validation | Quality capability | Planned | Repository and CI runners |
